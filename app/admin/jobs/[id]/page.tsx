  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 pt-6 pb-16">
        {/* Job summary card */}
        <div className="bg-secondary-fixed border-l-8 border-primary-container p-6 mb-8">
          <div className="flex items-start justify-between gap-4 mb-6">
            <h1 className="font-heading text-3xl font-bold uppercase tracking-tight text-on-secondary-fixed leading-tight">
              {job.name}
            </h1>
          ...
          <div className="space-y-3">
            {reports.length === 0 ? (
              ...
              reports.map(report => (
                <div
                  key={report.id}
                  className={`bg-secondary-fixed border-l-4 ${report.hasIssues ? 'border-l-red' : 'border-l-tertiary'}`}
                >
                  <div className="p-5">
                    {/* Top row: date + badge */}
